...
func _start(request: Dictionary) -> Dictionary:
	...
	if variant not in ["default", "worksite_carting_v1", "worksite_hauling_v1", "household_budget_v1", "household_livelihood_v1", "work_framework_v1", "community_life_v1", "world_danger_v1", "player_life_v1", "player_life_v2", "world_content_v1"] or (variant != "default" and next_scenario != "echo_realm"):
	...
	if variant in ["household_livelihood_v1", "work_framework_v1", "community_life_v1", "world_danger_v1", "player_life_v1", "player_life_v2", "world_content_v1"]:
	...
	if variant in ["work_framework_v1", "community_life_v1", "world_danger_v1", "player_life_v1", "player_life_v2", "world_content_v1"]:
	...
	elif variant in ["player_life_v2", "world_content_v1"]:
		options["player_life_version"] = 2
	if variant == "world_content_v1":
		options["content_extension_version"] = 1
	if variant in ["world_danger_v1", "player_life_v1", "player_life_v2", "world_content_v1"]:
