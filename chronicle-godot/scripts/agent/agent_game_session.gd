...
func _start(request: Dictionary) -> Dictionary:
	...
	if variant in ["household_livelihood_v1", "work_framework_v1", "community_life_v1", "world_danger_v1", "player_life_v1", "player_life_v2", "world_content_v1", "world_content_v2"]:
	...
	if variant in ["work_framework_v1", "community_life_v1", "world_danger_v1", "player_life_v1", "player_life_v2", "world_content_v1", "world_content_v2"]:
	...
	elif variant in ["player_life_v2", "world_content_v1", "world_content_v2"]:
		options["player_life_version"] = 2
	if variant in ["world_content_v1", "world_content_v2"]:
		options["content_extension_version"] = 2 if variant == "world_content_v2" else 1
	if variant in ["world_danger_v1", "player_life_v1", "player_life_v2", "world_content_v1", "world_content_v2"]:
