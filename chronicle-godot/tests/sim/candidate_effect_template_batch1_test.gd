...
func _run() -> void:
	...
	_check(_result_has_fact(market_result, "actor_asked_about_market_pressure"), "13. ask_market_pressure produces actor_asked_about_market_pressure fact")
	_check(_result_has_memory(market_result, "player", "learned_market_pressure"), "14. ask_market_pressure produces learned_market_pressure memory")
	...
	_check(
		...
		"15. batch one results are resolved"
	)
