...
- 可叙述状态：老陈发现了陈米藏着的发霉麦子
  原因：old_chen_discovered_spoiled_grain (fact_d07_054_old_chen_discovered_spoiled_grain)
  痕迹：overturned_grain_bag (trace_d07_009_overturned_grain_bag)
- 可叙述状态：陈米吃过发霉麦子后病倒了
  原因：chen_mi_fell_sick_from_spoiled_grain (fact_d08_062_chen_mi_fell_sick_from_spoiled_grain)
  痕迹：sick_child_at_shop_door (trace_d08_012_sick_child_at_shop_door)
...
- 陈米因持续饥饿吃掉了一部分发霉麦子。
  - Fact：chen_mi_ate_spoiled_grain；来源：[fact_d06_044_chen_mi_took_spoiled_grain]
  - Trace：spoiled_grain_crumbs, stomach_pain_sign；Memory：chen_mi_remembers_eating_spoiled_grain
- 老陈发现了陈米藏着的发霉麦子。
  - Fact：old_chen_discovered_spoiled_grain；来源：[fact_d06_044_chen_mi_took_spoiled_grain, fact_d06_045_old_chen_closed_shop_due_to_family_crisis]
  - Trace：overturned_grain_bag；Memory：old_chen_found_spoiled_grain
- 玛婶注意到老陈的店连续关门。
  - Fact：ma_shen_noticed_closed_shop；来源：[fact_d06_045_old_chen_closed_shop_due_to_family_crisis]
  - Trace：neighbor_footprints_at_shop, whispered_market_rumor；Memory：noticed_old_chen_shop_closed

### Day 8

- 陈米吃过发霉麦子后身体变差。
  - Fact：chen_mi_fell_sick_from_spoiled_grain；来源：[fact_d07_053_chen_mi_ate_spoiled_grain]
  - Trace：sick_child_at_shop_door；Memory：old_chen_remembers_chen_mi_sick
...
当天 LeadCandidate：
- caravan / scarcity_high_and_smuggler_raid / fact_d09_067_raid_supplies / risk 0.66 / urgency 0.90
- apparition / cult_ritual_and_mystic_pressure / fact_d09_065_region_daily_shift / risk 0.90 / urgency 0.90
